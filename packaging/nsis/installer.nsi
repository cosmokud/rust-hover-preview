...
Function PageReinstall
  ; Auto-upgrade: remove any previous install without showing a choice page.
  ; The installer handles process shutdown, config completion, and old-folder
  ...
  ; Check if there is an existing NSIS installation. If present, uninstall it
  ; silently, then skip this custom page.
