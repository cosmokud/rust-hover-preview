...
- A display change, a scale change, or a resume takes a document that is being played by the browser engine down with the rest of the preview, instead of leaving its window where the display it was placed for used to be.
