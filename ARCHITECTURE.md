...
- `text_preview.rs`: reading and decoding a text file, turning it into styled lines, laying them out for a box, and painting them with GDI into the same BGRA frame an image arrives in.
